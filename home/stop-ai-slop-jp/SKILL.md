...
description: AIで書いた日本語を、人間が書いた文章に戻す。「AI臭をなくしたい」「自然な文章で」のような、AIが出力した内容をそのまま出さず自然な表現に直したい旨の指示が来た時に発火する。下書き、編集、レビューで使う。全角ダッシュや偏愛語だけでなく、主体の不在、命題型H2、壮大化、両論併記、リズムの均一さも直す。
metadata:
